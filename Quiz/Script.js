...
async function GeneralQuiz() {
    ...
    Temp = `<select id="catégorie" name="catégorie"><option value="all">${DICOLANGtoSEE["All"]}</option><option value="img">${DICOLANGtoSEE["Images"]}</option><option value="oth">${DICOLANGtoSEE["Autres"]}</option>`;
